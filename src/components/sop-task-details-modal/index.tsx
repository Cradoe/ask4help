...
export const SopTaskDetailsModal = ({
  task,
  trigerButtonClass,
}: {
  task: SopTask;
  ...
  return (
    <div>
      <Modal
        ...
        trigerButtonClass={clsx(
          trigerButtonClass
            ? trigerButtonClass
            : "w-full block border-0 font-light"
        )}
      ...
      >
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-secondary-50/70 rounded-xl px-5 py-6">
            <div className="flex justify-between items-center gap-1 lg:gap-5 flex-wrap">
