...
export const WhyChooseUs = () => {
  return (
    <section className="mt-20 md:mt-32 xl:mt-40 pl-wrapper md:pl-wrapper-md lg:pl-wrapper-lg xl:pl-wrapper-xl grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-[60%_1fr] 4xl:grid-cols-1 gap-12 relative">
