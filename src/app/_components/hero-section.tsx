...
export const HeroSection = () => {
  return (
    <section className="relative bg-mobile-hero-bg md:bg-desktop-hero-bg min-h-[80vh] xl:min-h-[80vh] 2xl:min-h-[90vh] 4xl:min-h-[80vh] w-screen bg-cover bg-bottom grid md:grid-cols-2 2xl:grid-cols-[40%_1fr] pt-5 md:py-20 lg:py-36 md:items-center px-wrapper md:px-wrapper-md lg:px-wrapper-lg xl:px-wrapper-xl text-center md:text-left">
      <div>
        <h1
          className={clsx(
