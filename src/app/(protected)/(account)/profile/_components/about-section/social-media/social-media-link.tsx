...
export const SocialMediaLink = ({
  ...
  if (socialHandle.platform.name === SOCIAL_MEDIAS.FACEBOOK) {
    return (
      ...
      >
        <FaFacebook className="text-blue-600 text-3xl" /> <span>Facebook</span>
      </Link>
    );
  }
  ...
  if (socialHandle.platform.name === SOCIAL_MEDIAS.TWITTER) {
    return (
      ...
      >
        <FaXTwitter className="text-3xl" /> <span>Twitter (X)</span>
      </Link>
    );
  }
  ...
  if (socialHandle.platform.name === SOCIAL_MEDIAS.LINKEDIN) {
    return (
      ...
      >
        <FaLinkedin className="rounded-full text-3xl" /> <span>LinkedIn</span>
      </Link>
    );
  }
