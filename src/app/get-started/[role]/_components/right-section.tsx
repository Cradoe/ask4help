...
export const RightSection = ({ role }: { role: string }) => {
  return (
    <div className="bg-white px-wrapper md:px-wrapper-md lg:pr-wrapper-lg xl:pr-wrapper-xl 3xl:pr-wrapper-3xl 4xl:pr-wrapper-4xl pt-10 py-20 grid grid-cols-1 items-center">
      <div className="place-self-start justify-self-end flex items-center justify-between md:justify-end w-full">
        <Link
          href="/"
          className="focus:outline-none focus:ring-primary-600 focus:ring-2 rounded block md:hidden bg-secondary-500"
        >
          <Image
            src="/logo.svg"
            alt="Ask4help logo"
